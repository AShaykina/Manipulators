...
//    ArrayList<Sprite> grid;
    ...
    public Manipulator(int n, double l1, double l2, double l3, double fi1, double fi2, double fi3, double x, double y, double error) {//, ArrayList<Sprite> grid) {
        //    this.grid = grid;
        this.n = n;
    ...
    public void setPosition(short fi1, short fi2, short fi3) {
        this.fi1 = fi1;
        this.fi2 = fi2;
        this.fi3 = fi3;
    ...
    public boolean setGoal(double x, double y) {
    ...
    public boolean setCollision(double x20, double y20, double x21, double y21, double x22, double y22, double x23, double y23) {
        double x1;
        double y1;
        double x2;
        double y2;
    ...
    public ArrayList<Point3> calculate() {
